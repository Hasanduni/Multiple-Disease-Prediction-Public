...
with st.sidebar:
    selected = option_menu('Multiple Disease Prediction System ML',
                           ...
                           icons = ['activity','heart','person'],
                            ...
                            default_index=0 )
#default index means starting page like in array
...
if(selected=='Diabetes Prediction'):
    ...
    with col2:
        Glucose=st.text_input('Glusoce Level')
    ...
    if st.button('Diabtets Test Result'):
...
if(selected=='Heart Disease Prediction'):
    ...
    #page title
    st.title('Heart Disease Predictionsing ML')
...
if(selected=='Parkinsons Prediction'):
    ...
    #page title
    st.title('Parkinsons Disease Predictionsing ML')
